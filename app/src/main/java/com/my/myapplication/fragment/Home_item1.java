package com.my.myapplication.fragment;
...
//分类数据页 循环创建
public class Home_item1 extends Fragment {
    ...
    public static Home_item1 newInstance(String param1, String param2) {
        Home_item1 fragment = new Home_item1();
...
//        接收创建该类参数
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_home_item1, container, false);
//查找Recyclerview控件
        mRecyclerview = view.findViewById(R.id.recyclerview);
        //绑定Recyclerview适配器
        mMyAdapter = new MyAdapter(getActivity(), mBeanList);
        ...
        if ("All".equals(mParam1)) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        // 这里是调用耗时操作方法 获取全部
                        mBeanList = MyHelper.getInstance(getActivity()).getAllData();
